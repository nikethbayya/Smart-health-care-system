...
def save():
    hear_info = hear.get()
    Label(p2, text="Data added successfully", fg="green", font=("Brush Script MT", 15,"bold")).pack() 
...
def save1():
    s1_info = s1.get()
    e1_info = e1.get() 
    Label(p3, text="Data added successfully", fg="green", font=("Brush Script MT", 15,"bold")).pack() 
    file = open("analysis.txt","a") 
...
def save2():
    s2_info = s2.get()
    e2_info = e2.get() 
    Label(p4, text="Data added successfully", fg="green", font=("Brush Script MT", 12,"bold")).pack() 
    file = open("analysis.txt","a") 
...
def main_account_screen(): 
    ...
    Label(main_screen,text=s, bg="DarkOliveGreen3",fg="black",width=300, height="4", font=("Copperplate Gothic Light", 15,"bold")).pack()
    Label(text="").pack()
    l=Label(main_screen,text=s1,bg="DarkOliveGreen3",fg="maroon", font=("sitka small", 18,"bold"))
    l.place(x=800,y=50)  
    # bg = PhotoImage(file = "")  
    ...
    Label(text="").pack() 
    Label(main_screen, bg="coral", width=300, height="25", font=("Calibri", 13)).pack()
